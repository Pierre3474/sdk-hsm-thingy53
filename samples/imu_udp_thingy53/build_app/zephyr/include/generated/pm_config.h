...
#define PM_NUM 11
#define PM_ALL_BY_SIZE "ram_flash mcuboot_pad otp pcd_sram mcuboot settings_storage mcuboot_primary_1 mcuboot_secondary_1 sram_primary app mcuboot_primary_app mcuboot_secondary mcuboot_primary external_flash"
